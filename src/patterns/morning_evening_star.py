...
def morning_evening_star(data: pd.DataFrame):
    ...
    1 is morning star, -1 is evening star, 0 means nothing
    Rule.
    If bar[0],bar[1],bar[2] are combined, calculate whether they are hammers
    """
